...
## For ISPO Research Competition 2026
...
| Battery 9V Supply | Use The Box Holder DC OUTPUT | 1 |
| Board | PCB Universal Board | 1 |
...
#### 1. Clone Repository
```bash
git clone https://github.com/Moechhh/BINSAI_RESEARCH
cd BINSAI_RESEARCH
